...
New-HTML -TitleText 'AD_OVH' {
 ...
 New-HTMLSection -Name 'Objects in Default OUs'  {
    ...
    New-HTMLPage -Name 'Groups' {
       ...
       New-HTMLSection -Name 'Groups Overivew' -Invisible {
         New-HTMLPanel {
       ...
       New-HTMLSection -Name 'Active Directory Groups With Members' -HeaderBackGroundColor teal -HeaderTextAlignment left {
         New-HTMLPanel {
                ...
                New-HTMLTable -DataTable $Table -DefaultSortColumn Name -HideFooter 
            }
        }
    ...
    New-HTMLPage -Name 'OU' {
       ...
       New-HTMLSection -Name 'Organizational Units infos' -invi {
         New-HTMLPanel {
    ...
    New-HTMLTab -Name 'Computers' -IconBrands microsoft {
       ...
       New-HTMLSection -Name 'Computers Overivew' -Invisible  {
         ...
         New-HTMLSection -name 'Potentiel Win10/11 End of support' {
