...
Get-ADUser -Filter * -SearchBase $DefaultUsersOU -Properties Name,UserPrincipalName,Enabled,LastLogon | foreach-object {
...
$Allobjects = @(
    ...
    [pscustomobject]@{Name='Serveur Printer'; Count=$($printers.count)}
)
...
New-HTML -TitleText 'AD_OVH' {
    ...
    New-HTMLTab -Name 'Dashboard' -IconRegular chart-bar  {
     ...
     New-HTMLTabStyle  -BackgroundColorActive teal   
      ...
      #New-HTMLTable -DataTable $Allobjects -HideFooter -HideButtons -DisableSearch -DisablePaging -DisableInfo 
      ...
      New-HTMLText -TextBlock {
      New-HTMLText -Text '337' -Alignment justify -FontSize 25 -FontWeight bold 
      ...
      New-HTMLText -TextBlock {
      New-HTMLText -Text $($ADObjectTable.Count) -Alignment left -FontSize 25 -FontWeight bold
      ...
      New-HTMLText -TextBlock {
      New-HTMLText -Text $($ExpiringAccountsTable.count) -Alignment left -FontSize 25 -FontWeight bold
   ...
   New-HTMLSection -Invisible {
      ...
      New-HTMLSection -Name 'UPN Suffix' -HeaderTextAlignment center -HeaderBackGroundColor Black -Width "60%"  {
                New-HTMLTable -DataTable $DomainTable -HideButtons -DisableInfo -DisableSearch -HideFooter
      }
      ...
      New-HTMLSection -Name "Accounts Created in $UserCreatedDays Days or Less" -HeaderBackGroundColor DarkBlue {
                new-htmlTable -HideFooter -DataTable $NewCreatedUsersTable -DisableInfo -HideButtons -PagingLength 6 -DisableSearch
            }
 ...
 New-HTMLSection -Name 'Objects in Default OUs' -Invisible  {
      ...
      New-HTMLSection -Name 'Computers in default OU' -HeaderBackGroundColor teal   {
                new-htmlTable -HideFooter -DataTable ($DefaultComputersinDefaultOUTable | select Name,Enabled,'Operating System','Modified Date','Password Last Set')  -PagingLength 12 -HideButtons -DisableSearch
            }
      ...
      New-HTMLSection -Name 'Users in Default OU' -HeaderBackGroundColor brown {
               ...
               New-HTMLTable -HideFooter -DataTable ($DefaultUsersinDefaultOUTable | select name,UserPrincipalName,Enabled,'Protected from Deletion','Last Logon')  -PagingLength 12 -HideButtons -DisableSearch
            }
    ...
    New-HTMLPage -Name 'GPO' {
       ...
       New-HTMLSection -name 'Inlinked Details' {
              New-HTMLTable -DataTable $gponotlinked 
       }

       New-HTMLSection -Name 'Linked Vs Inliked GPOs'   {
            New-HTMLChart {
                New-ChartLegend -LegendPosition bottom 
       ...
       New-HTMLSection -Name 'Computers Overivew' -Invisible  {
         ...
         New-HTMLSection -name 'Potentiel Win10 End of support' {
           ...
           New-HTMLChart {
                ...
                New-ChartDonut -Name 'Windows 10/11' -Value $allwin1011
            }
